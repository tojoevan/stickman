...
# The correct ITEMS block
items_block = """const ITEMS = {
  weapons: [
...
# Replace everything from `const ITEMS = {` to just before `const INITIAL_CHAR:`
import re

start_idx = content.find("const ITEMS = {")
end_idx = content.find("const INITIAL_CHAR: Character = {")
